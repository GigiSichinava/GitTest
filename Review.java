...
public class Review extends GraphicsProgram {
    ...
    private GOval oval;  // This is the instance variable
    ...
    public void run() {
        ...
        ovalWidth = width;
        ovalHeight = height;
        oval = new GOval(ovalWidth, ovalHeight); // Use the instance variable
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // Add other conditions for moving left, right, and up
    }
}
