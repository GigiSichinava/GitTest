...
public class Masivebi extends ConsoleProgram{
	public void run(){
		
		int[] myArr = new int[10];
//		int[] myArr = {10, 20, 30};
		int[] myArr2 = {0, 5, 6, 7, 8};  // meorenairad sheyvana masivis
		...
		if(Arrays.equals(myArr2, myArr3)){    // shedareba masivebis
			println("Equals");
		}else{
			println("false");
		}
		...
		int[] toSort = {10, 5, 61, 7, 10, -2, 8, 9};  // zrdadobit dalageba
		Arrays.sort(toSort);
